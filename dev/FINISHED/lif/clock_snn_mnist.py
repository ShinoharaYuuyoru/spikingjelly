...
parser.add_argument('--dataset-dir', default="/data/piaoqy/snn_ds", help='保存MNIST数据集的位置，例如“./”\n Root directory for saving MNIST dataset, e.g., "./"')
parser.add_argument('--log-dir', default="/home/piaoqy/SNN/SpikingJelly/tensorboard_log", help='保存tensorboard日志文件的位置，例如“./”\n Root directory for saving tensorboard logs, e.g., "./"')
parser.add_argument("--model_output_dir", default="/home/piaoqy/SNN/SpikingJelly/model_output", help="Model directory for saving.")
