...
def configurations():
    ...
    # Device, data dir, pretrained model, and AMP(use FP16 instead FP32 to use less RAM and accelerate training).
    parser.add_argument('--device', default='cuda:0', help='device')
    parser.add_argument('--dataset_dir', type=str, default="./", help='root dir of Fashion-MNIST dataset')
...
def main():
    ...
    * :ref:`API in English <conv_fashion_mnist.main-en>`
    ...
    # Usage:
    # python conv_fashion_mnist.py --opt SGD --amp
    # python conv_fashion_mnist.py --opt SGD --amp --cupy
...
def visualization():
    ...
    # mkdirs
    if os.path.exists('./plt') == False:
        os.mkdir('./plt')
    if os.path.exists('./plt/input') == False:
        os.mkdir('./plt/input')
    if os.path.exists('./plt/output') == False:
        os.mkdir('./plt/output')
